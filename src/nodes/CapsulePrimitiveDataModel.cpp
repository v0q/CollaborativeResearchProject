...
std::string CapsulePrimitiveDataModel::getShaderCode()
{
  ...
  return "sdCapsule(vec3(" + m_transform + " * vec4(_position, 1.0)).xyz, vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0),  vec3(clamp(" + m_color.m_x + ", 0.0, 1.0), clamp(" + m_color.m_y + ", 0.0, 1.0), clamp(" +m_color.m_z + ", 0.0, 1.0)))";
}
